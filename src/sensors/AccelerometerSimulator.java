...
public class AccelerometerSimulator implements Runnable{

	private SimulatedSensor cbc = new SimulatedSensor();
	...
	public AccelerometerSimulator(double[] pos, double[] v, long lag, long timeout){
		this.pos = pos;
		this.v = v;
